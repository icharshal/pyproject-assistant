...
def open_website(command: str):
    if 'open' in command:
        ...
        # Clean the URL by replacing spaces with nothing (or can choose a different delimiter like '-')
        website = website.replace(" ", "")  # Remove spaces

        # Ensure the website starts with 'http://' or 'https://'
        if not website.startswith('http://') and not website.startswith('https://'):
            website = 'http://' + website.removeprefix("website")
